        ...
        <b-col sm="12" md="4" class="bg-light">
            <div class="login-wrapper">
              <b-card>
                ...
                <h6 class="text-center mt-2 mb-4">Ministry of Commerce</h6>
                <b-form>
                    <b-form-group
                        id="user"
                    ...
                    <b-button block type="submit" class="my-4" variant="primary">Login</b-button>
                    <b-small>Don’t have an account? <a href="javascript:">SignUp</a></b-small>
                </b-form>
              </b-card>
            </div>
        </b-col>
